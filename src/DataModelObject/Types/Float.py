...
class Float(DataTypeObject):
	...
	def __sub__(self, other):
		return sub(self.__value__, other.__value__ if isinstance(other, DataTypeObject) else other)

	def __mul__(self, other):
		return mul(self.__value__, other.__value__ if isinstance(other, DataTypeObject) else other)

	def __matmul__(self, other):
		return matmul(self.__value__, other.__value__ if isinstance(other, DataTypeObject) else other)

	def __truediv__(self, other):
		return truediv(self.__value__, other.__value__ if isinstance(other, DataTypeObject) else other)

	def __floordiv__(self, other):
		return floordiv(self.__value__, other.__value__ if isinstance(other, DataTypeObject) else other)
	...
	def __and__(self, other):
		return and_(self.__value__, other.__value__ if isinstance(other, DataTypeObject) else other)

	def __or__(self, other):
		return or_(self.__value__, other.__value__ if isinstance(other, DataTypeObject) else other)

	def __xor__(self, other):
		return xor(self.__value__, other.__value__ if isinstance(other, DataTypeObject) else other)
